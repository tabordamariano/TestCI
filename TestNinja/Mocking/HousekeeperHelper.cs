...
namespace TestNinja.Mocking
{
    public class HousekeeperHelper
    {
        ...
        public HousekeeperHelper(IFileSaver fileSaver, IEmailSender emailSender, IHousekeeperRepository repository = null)
        {
            _fileSaver = fileSaver;
            _emailSender = emailSender;
            _repository = repository ?? new HousekeeperRepository();
        }
        ...
        public bool SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                var statementFilename = _fileSaver.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
